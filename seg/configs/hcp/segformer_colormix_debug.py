...
name = f"{dataset}{datatag}_{name_architecture}_{norm}-burnin{burnin}-NM-nohistnorm"
# nohistnorm - no normaliztion b/w 0 and 1 in the histogram matching
